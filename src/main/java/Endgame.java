...
public class Endgame extends JPanel implements ActionListener, KeyListener {
    ...
    public Endgame() {
        ...
        // Load images
        background = new ImageIcon(Objects.requireNonNull(getClass().getResource("./ultron.png"))).getImage();
        Image heroImage = new ImageIcon(Objects.requireNonNull(getClass().getResource("/iron.png"))).getImage();
